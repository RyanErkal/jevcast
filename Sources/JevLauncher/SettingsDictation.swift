    ...
    var body: some View {
        Form {
            ...
            Section("Luna clean-up") {
                ...
                Text("Jevcast removes “um” and “uh” on this Mac. Luna can also fix punctuation and self-corrections. Turn on “Dictation transcripts” in Settings › Luna to send transcript text; audio is never sent.")
                    .font(.caption).foregroundStyle(.secondary)
